...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        {
            var jogos = await _jogoService.ObterTodosJogos(pagina, quantidade);
        ...
        [HttpGet("{idJogo:guid}")]
        public async Task<ActionResult<JogoViewModel>> ObterJogoPorId([FromRoute] Guid idJogo)
        {
            var jogo = await _jogoService.ObterJogoPorId(idJogo);
